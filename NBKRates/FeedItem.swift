...
class FeedItem: NSObject {
    ...
    var feedChange: String?
    var feedQuantity: String?
    ...
    override var description: String {
        var desc = "Feed Item:\n"
            ...
            if (feedChange != nil) { desc += "\t- Change: \(String(describing: feedChange))\n" }
            if (feedQuantity != nil) { desc += "\t- Quantity: \(String(describing: feedQuantity))\n" }
